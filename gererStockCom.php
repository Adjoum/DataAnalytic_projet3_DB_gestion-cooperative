...
<head>
    ...
    <title>Gestion de stock des commandes</title>
</head>
<body>
<div class="h1-description">
       <h1>La gestion du stock à chaque commande </h1>
</div>
    ...
    <?php  
        if (isset($_GET["gererStockCom"])) {
            ...
            $stockCom = gererStockCom(trim($_GET["CodeF"]), trim($_GET["refProd"]), trim($_GET["qteLiv"]));
            include_once("close_DB.php");
            }   
        echo "<p>Le stock de commande disponible pour cette référence est de <strong>$stockCom</strong>.</p>";
